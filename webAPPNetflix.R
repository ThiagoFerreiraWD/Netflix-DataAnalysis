...
dataset1 <- read.csv('https://raw.githubusercontent.com/ThiagoFerreiraWD/Netflix-DataAnalysis/main/dataset1.csv')
...
genre <- read.csv('https://raw.githubusercontent.com/ThiagoFerreiraWD/Netflix-DataAnalysis/main/dataset2.csv')
tree <- read.csv('https://raw.githubusercontent.com/ThiagoFerreiraWD/Netflix-DataAnalysis/main/dataset3.csv')
countries <- read.csv('https://raw.githubusercontent.com/ThiagoFerreiraWD/Netflix-DataAnalysis/main/dataset6.csv')
...
ui <- navbarPage(
                 ...
                 tabPanel('Veja Mais',
                          h3(tags$a(href="https://github.com/ThiagoFerreiraWD/Netflix-DataAnalysis", "Projeto Completo")),
                          h3(tags$a(href="https://thiagoferreirads.com", "Site Pessoal"))
                          )
)
